...
void updatePlayer2() {
    ...
    if ((~(buttons) & ((1<<5))) && player2.x >= -4) {
        player2.direction = LEFT;
        player2.isMoving = 1;
        player2.x -= player2.xVel;
    } else if ((~(buttons) & ((1<<4))) && player2.x < mapWidth2) {
        player2.direction = RIGHT;
        player2.isMoving = 1;
        player2.x += player2.xVel;
    }
    ...
    if ((!(~(oldButtons) & ((1<<0))) && (~(buttons) & ((1<<0)))) && (enemy01.active || enemy02.active || enemy03.active)
            && (player2.attack != 1) && ((enemy01.x - player2.x) <= 25
            || ((enemy02.x - player2.x) <= 25) || ((enemy03.x - player2.x) <= 25))) {
        player2.attack = 1;
    }

    if ((!(~(oldButtons) & ((1<<6))) && (~(buttons) & ((1<<6)))) && player2.isJumping == 0) {
        player2.isJumping = 1;
...
void drawGame2() {
    ...
    if ((~(buttons) & ((1<<7))) && player2.isMoving && player2.active) {
    ...
    if (enemy01.active) {
        if (enemy01.isHit == 0) {
            ...
            if (enemy01.timeUntilNextFrame == 0) {
                enemy01.timeUntilNextFrame = 10;
                enemy01.currFrame = (enemy01.currFrame + 1) % enemy01.numOfFrames;
            }
            shadowOAM[1].attr2 = (((0) & 0xF) << 12) | (((4) * 32 + (enemy01.currFrame*4)) & 0x3FF);
        } else {
            enemy01.aniCounter--;
            ...
            shadowOAM[1].attr2 = (((0) & 0xF) << 12) | (((9) * 32 + (enemy01.currentFrame*4)) & 0x3FF);
        }
        shadowOAM[1].attr0 = (0<<13) | (0<<14) | ((enemy01.y) & 0xFF);
        shadowOAM[1].attr1 = (2<<14) | (((int)enemy01.x) & 0x1FF) | (1<<12);
    ...
    if (enemy02.active) {
        if (enemy02.isHit == 0) {
            ...
            if (enemy02.timeUntilNextFrame == 0) {
                enemy02.timeUntilNextFrame = 10;
                enemy02.currFrame = (enemy02.currFrame + 1) % enemy02.numOfFrames;
            }
            shadowOAM[2].attr2 = (((0) & 0xF) << 12) | (((4) * 32 + (enemy02.currFrame*4)) & 0x3FF);
        } else {
            enemy02.aniCounter--;
            ...
            shadowOAM[2].attr2 = (((0) & 0xF) << 12) | (((9) * 32 + (enemy02.currentFrame*4)) & 0x3FF);
            enemy02.active = 0;
        }
        shadowOAM[2].attr0 = (0<<13) | (0<<14) | ((enemy02.y) & 0xFF);
        shadowOAM[2].attr1 = (2<<14) | (((int)enemy02.x) & 0x1FF) | (1<<12);
    }
    else {
    ...
    if (enemy03.active) {
        if (enemy03.isHit == 0) {
            ...
            if (enemy03.timeUntilNextFrame == 0) {
                enemy03.timeUntilNextFrame = 10;
                enemy03.currFrame = (enemy03.currFrame + 1) % enemy03.numOfFrames;
            }
            shadowOAM[3].attr2 = (((0) & 0xF) << 12) | (((4) * 32 + (enemy03.currFrame*4)) & 0x3FF);
        } else {
            enemy03.aniCounter--;
            ...
            shadowOAM[3].attr2 = (((0) & 0xF) << 12) | (((9) * 32 + (enemy03.currentFrame*4)) & 0x3FF);
            enemy03.active = 0;
        }
        shadowOAM[3].attr0 = (0<<13) | (0<<14) | ((enemy03.y) & 0xFF);
        shadowOAM[3].attr1 = (2<<14) | (((int)enemy03.x) & 0x1FF) | (1<<12);
    }
    else {
...
void drawPlayer2() {
    if (player2.active) {
        if (player2.isMoving) {
            player2.timeUntilNextFrame--;
            if (player2.timeUntilNextFrame == 0) {
                player2.timeUntilNextFrame = 10;
                player2.currentFrame = (player2.currentFrame + 1) % player2.numOfFrames;
            }
            shadowOAM[0].attr2 = (((0) & 0xF) << 12) | (((0) * 32 + (player2.currentFrame*4)) & 0x3FF);
            ...
            shadowOAM[0].attr2 = (((0) & 0xF) << 12) | (((0) * 32 + (16 + player2.currentFrame * 4)) & 0x3FF);
        } else if ((!(~(oldButtons) & ((1<<7))) && (~(buttons) & ((1<<7)))) && ((!(~(oldButtons) & ((1<<5))) && (~(buttons) & ((1<<5)))) || (!(~(oldButtons) & ((1<<4))) && (~(buttons) & ((1<<4)))))) {
            shadowOAM[0].attr2 = (((0) & 0xF) << 12) | (((9) * 32 + (17)) & 0x3FF);
        } else {
            player2.currentFrame = 0;
        }
        shadowOAM[0].attr0 = (0<<13) | (0<<14) | ((player2.y) & 0xFF);
        shadowOAM[0].attr1 = (2<<14) | ((player2.x) & 0x1FF);
...
void drawBites2() {
    ...
    if (bites == 1) {
        ...
        shadowOAM[10].attr0 = (0<<13) | (2<<14) | ((0) & 0xFF);
        shadowOAM[10].attr1 = (1<<14) | ((50 + hOff2) & 0x1FF);
        shadowOAM[10].attr2 = (((0) & 0xF) << 12) | (((5) * 32 + (23)) & 0x3FF);
    }
    if (bites == 2) {
        shadowOAM[10].attr0 |= (2<<8);
        shadowOAM[12].attr0 |= (2<<8);
        shadowOAM[11].attr0 = (0<<13) | (2<<14) | ((0) & 0xFF);
        shadowOAM[11].attr1 = (1<<14) | ((50 + hOff2) & 0x1FF);
        shadowOAM[11].attr2 = (((0) & 0xF) << 12) | (((5) * 32 + (24)) & 0x3FF);
    }
    if (bites == 3) {
        shadowOAM[10].attr0 |= (2<<8);
        shadowOAM[11].attr0 |= (2<<8);
        shadowOAM[12].attr0 = (0<<13) | (2<<14) | ((0) & 0xFF);
        shadowOAM[12].attr1 = (1<<14) | ((50 + hOff2) & 0x1FF);
        shadowOAM[12].attr2 = (((0) & 0xF) << 12) | (((5) * 32 + (25)) & 0x3FF);
    }
    if (bites == 0) {
        shadowOAM[10].attr0 |= (2<<8);
        shadowOAM[11].attr0 |= (2<<8);
