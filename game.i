...
void updatePlayer() {
    ...
    if ((~(buttons) & ((1<<5))) && player.x >= -4) {
        player.direction = LEFT;
        player.isMoving = 1;
        player.x -= player.xVel;
    } else if ((~(buttons) & ((1<<4))) && player.x < 240) {
        player.direction = RIGHT;
        player.isMoving = 1;
        player.x += player.xVel;
    }

    if ((!(~(oldButtons) & ((1<<0))) && (~(buttons) & ((1<<0)))) && (enemy.active || enemy2.active || enemy3.active)
    ...
    if ((!(~(oldButtons) & ((1<<7))) && (~(buttons) & ((1<<7))))) {
        player.y = 40;
        ((screenblock *)0x6000000)[0].tilemap[((0) * (32) + (240 / 2))] = ((148 & 0x3FF));



    }

    if ((!(~(oldButtons) & ((1<<6))) && (~(buttons) & ((1<<6)))) && player.isJumping == 0) {
        player.isJumping = 1;
    ...
    if (enemy.active) {
        if (enemy.isHit == 0) {
            ...
            if (enemy.timeUntilNextFrame == 0) {
                enemy.timeUntilNextFrame = 10;
                enemy.currFrame = (enemy.currFrame + 1) % enemy.numOfFrames;
            }
            shadowOAM[1].attr2 = (((0) & 0xF) << 12) | (((4) * 32 + (enemy.currFrame*4)) & 0x3FF);
        } else {
            enemy.aniCounter--;
            ...
            shadowOAM[1].attr2 = (((0) & 0xF) << 12) | (((9) * 32 + (enemy.currentFrame*4)) & 0x3FF);
        }
        shadowOAM[1].attr0 = (0<<13) | (0<<14) | ((enemy.y) & 0xFF);
        shadowOAM[1].attr1 = (2<<14) | (((int)enemy.x) & 0x1FF) | (1<<12);
    ...
    if (enemy2.active) {
        if (enemy2.isHit == 0) {
            ...
            if (enemy2.timeUntilNextFrame == 0) {
                enemy2.timeUntilNextFrame = 10;
                enemy2.currFrame = (enemy2.currFrame + 1) % enemy2.numOfFrames;
            }
            shadowOAM[2].attr2 = (((0) & 0xF) << 12) | (((4) * 32 + (enemy2.currFrame*4)) & 0x3FF);
        } else {
            enemy2.aniCounter--;
            ...
            shadowOAM[2].attr2 = (((0) & 0xF) << 12) | (((9) * 32 + (enemy2.currentFrame*4)) & 0x3FF);
            enemy2.active = 0;
        }
        shadowOAM[2].attr0 = (0<<13) | (0<<14) | ((enemy2.y) & 0xFF);
        shadowOAM[2].attr1 = (2<<14) | (((int)enemy2.x) & 0x1FF) | (1<<12);
    }
    else {
    ...
    if (enemy3.active) {
        if (enemy3.isHit == 0) {
            ...
            if (enemy3.timeUntilNextFrame == 0) {
                enemy3.timeUntilNextFrame = 10;
                enemy3.currFrame = (enemy3.currFrame + 1) % enemy3.numOfFrames;
            }
            shadowOAM[3].attr2 = (((0) & 0xF) << 12) | (((4) * 32 + (enemy3.currFrame*4)) & 0x3FF);
        } else {
            enemy3.aniCounter--;
            ...
            shadowOAM[3].attr2 = (((0) & 0xF) << 12) | (((9) * 32 + (enemy3.currentFrame*4)) & 0x3FF);
            enemy3.active = 0;
        }
        shadowOAM[3].attr0 = (0<<13) | (0<<14) | ((enemy3.y) & 0xFF);
        shadowOAM[3].attr1 = (2<<14) | (((int)enemy3.x) & 0x1FF) | (1<<12);
    }
    else {
...
void drawPlayer() {
    if (player.active) {
        if ((!(~(oldButtons) & ((1<<7))) && (~(buttons) & ((1<<7))))) {
            ((charblock *)0x06000000)[4]->tileData[((player.y) * (32) + (player.x + hOff))] = ((305 & 0x3FF));
            ((charblock *)0x06000000)[4]->tileData[((player.y) * (32) + (player.x + hOff))] = ((308 & 0x3FF));
            ((charblock *)0x06000000)[4]->tileData[((player.y) * (32) + (player.x + hOff))] = ((401 & 0x3FF));
            ((charblock *)0x06000000)[4]->tileData[((player.y) * (32) + (player.x + hOff))] = ((404 & 0x3FF));
        }
        else {
            if (player.isMoving) {
                ...
                shadowOAM[0].attr2 = (((0) & 0xF) << 12) | (((0) * 32 + (player.currentFrame*4)) & 0x3FF);
                ...
                shadowOAM[0].attr2 = (((0) & 0xF) << 12) | (((0) * 32 + (16 + player.currentFrame * 4)) & 0x3FF);
            } else {
                player.currentFrame = 0;
            }
            shadowOAM[0].attr0 = (0<<13) | (0<<14) | ((player.y) & 0xFF);
            shadowOAM[0].attr1 = (2<<14) | ((player.x) & 0x1FF);
...
void drawBites() {
    if (bites == 1) {
        ...
        ((unsigned short *)0x5000000)[4] = (((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10);
        ((unsigned short *)0x5000000)[6] = (((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10);
        ((unsigned short *)0x5000000)[8] = (((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10);
        ...
        shadowOAM[4].attr0 = (0<<13) | (2<<14) | ((0) & 0xFF);
        shadowOAM[4].attr1 = (1<<14) | ((50 + hOff) & 0x1FF);
        shadowOAM[4].attr2 = (((0) & 0xF) << 12) | (((5) * 32 + (23)) & 0x3FF);
    }
    if (bites == 2) {
        shadowOAM[4].attr0 |= (2<<8);
        shadowOAM[6].attr0 |= (2<<8);
        shadowOAM[5].attr0 = (0<<13) | (2<<14) | ((0) & 0xFF);
        shadowOAM[5].attr1 = (1<<14) | ((50 + hOff) & 0x1FF);
        shadowOAM[5].attr2 = (((0) & 0xF) << 12) | (((5) * 32 + (24)) & 0x3FF);
    }
    if (bites == 3) {
        shadowOAM[5].attr0 |= (2<<8);
        shadowOAM[4].attr0 |= (2<<8);
        shadowOAM[6].attr0 = (0<<13) | (2<<14) | ((0) & 0xFF);
        shadowOAM[6].attr1 = (1<<14) | ((50 + hOff) & 0x1FF);
        shadowOAM[6].attr2 = (((0) & 0xF) << 12) | (((5) * 32 + (25)) & 0x3FF);
    }
    if (bites == 0) {
        shadowOAM[4].attr0 |= (2<<8);
        shadowOAM[5].attr0 |= (2<<8);
